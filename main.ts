...
<footer><span class="footer-brand">Vergil’s Coffee Table <span class="footer-version">· Tempus fugit v${version}</span></span><span id="save-note">Settings saved on this browser</span></footer></main>
